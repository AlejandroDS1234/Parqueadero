...
while True:
    ...
    if entrada=="E":
        ...
        #tipo de vehiculo
        while True:
            tipo=input("Ingrese el tipo de vehiculo (Moto, Carro, Camioneta): ").upper()#pide el tipo de vehiculo y lo pone en mayusculas
        ...
        while True:
            hora_entrada,minutos_entrada=input("Ingrese la hora de entrada (HH:MM): ").split(":")
            if int(hora_entrada)>24 or int(hora_entrada)<0 or int(minutos_entrada)>59 or int(minutos_entrada)<0:
                ...
                break
        while True:
            fecha_entrada_dia,fecha_entrada_mes=input("Ingrese la fecha de entrada (DD/MM): ").split("/")
        ...
        print(f"Los datos ingresados son: Placa: {placa}, Tipo: {tipo}, Hora de entrada: {hora_entrada_[0]}:{hora_entrada_[1]}, Fecha de entrada: {fecha_entrada[0]}/{fecha_entrada[1]}")
            
    #salida
    elif entrada=="S":
        if len(vehiculos)!=0:
            while True:    
                placa_salida=input("Ingrese la placa de su vehiculo para salir: ").upper()
            ...
            while True:
                if vehiculos[contador][0]==placa_salida:
                    while True:
                        hora_salida,minutos_salida=input("Ingrese la hora de salida (HH:MM): ").split(":")
                        if int(hora_salida)>24 or int(hora_salida)<0 or int(minutos_salida)>59 or int(minutos_salida)<0:
                            ...
                            break
                    while True:
                        fecha_salida_dia,fecha_salida_mes=input("Ingrese la fecha de salida (DD/MM): ").split("/")
                    ...
                    if fecha_salida[1]==vehiculos[contador][3][1]:
                        ...
                        if dias_parqueo<0:
                            ...
                            if horas_parqueo<0:
                                ...
                                print(f"Su vehiculo estubo {horas_parqueo} horas en el parqueadero, debe pagar: {total_pagar}$")
                                historial.append((vehiculos[contador],{"pago":total_pagar},(hora_salida,fecha_salida)))
